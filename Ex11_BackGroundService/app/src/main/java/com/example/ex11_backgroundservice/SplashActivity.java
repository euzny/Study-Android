...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ProgreeDialog <= 화면 위에 띄워져서 어떤 처리를 하는 동안 사용자에게 어떤 처리가 이루어지고 있음을 알려주는 위젯
        //어떤 처리가 이루어지고 잇음을 알려주는 위젯
        //DB에 접속해서 어떤 처리를 오랫동안 함. 언제까지 할지는 모름
        // 그동안 앱은 정지상태에 있음 조작x
        //사용자 입장에서는 앱이 멈춘건지 작업중인지를 인지를 못함
        //작업중이라는것을 알려주기 위한것.
        ProgressDialog dialog = new ProgressDialog(SplashActivity.this);
       // ProgressDialog.show(SplashActivity.this, "타이틀","메시지");
       dialog.setTitle("지금 프로젝트를 로딩 중입니다. 소요시간 3초");
       dialog.show();  // <= 실제 보여줌.
        
        // 필요하다면 한쪽에 정리해두고 나중에 복붙해서  쓸 것
        //외우지 말것, 단 ※ 인터페이스를 파라메터로 입력받는 메소드 호출
