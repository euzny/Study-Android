    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn1).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //EditText에 입력된 값이 스프링에 찍히게 하려면 어디부분을 수정해서 작업을 해야할까?
                //AskTask task = new AskTask("and",edt_data1.getText().toString(),edt_data2.getText().toString());
                AskTask task = new AskTask("toFromAnd",edt_data1.getText().toString(),edt_data2.getText().toString());
